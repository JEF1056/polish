function FooterComponent() {
    ...
    <footer className="footer p-10 bg-neutral text-neutral-content rounded-t-lg">
        <div>
            ...
            <a className="link link-hover" href="https://github.com/JEF1056">Jess Fan</a>
        ...
        <div>
            ...
            <span className="text-green-200 hover:bg-base-200 rounded">Click to accept addition</span>
            <span className="text-red-200 hover:bg-base-200 rounded">Click to accept removal</span>
            <span className="opacity-50 hover:bg-base-100 rounded">Click to accept sentence completion</span>
        </div>
    </footer>
    );
}
